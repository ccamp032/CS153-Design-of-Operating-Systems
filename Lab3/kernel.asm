...
80100ba0:	c7 40 0c 01 00 00 00 	movl   $0x1,0xc(%eax)
...
801038a8:	89 02                	mov    %eax,(%edx)
  *np->tf = *curproc->tf;
801038aa:	8b 7a 1c             	mov    0x1c(%edx),%edi
  np->parent = curproc;
801038ad:	89 5a 18             	mov    %ebx,0x18(%edx)
  *np->tf = *curproc->tf;
801038b0:	8b 73 1c             	mov    0x1c(%ebx),%esi
801038b3:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
801038b5:	31 f6                	xor    %esi,%esi
  np->stack_pages = curproc->stack_pages;
801038b7:	8b 43 0c             	mov    0xc(%ebx),%eax
801038ba:	89 42 0c             	mov    %eax,0xc(%edx)
  np->tf->eax = 0;
801038bd:	8b 42 1c             	mov    0x1c(%edx),%eax
...
80103958:	c7 47 08 00 00 00 00 	movl   $0x0,0x8(%edi)
    np->state = UNUSED;
8010395f:	c7 47 10 00 00 00 00 	movl   $0x0,0x10(%edi)
    return -1;
...
8010559e:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
            myproc()->pid, myproc()->name, tf->trapno,
801055a1:	83 c6 70             	add    $0x70,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
801055b0:	8b 40 14             	mov    0x14(%eax),%eax
...
801055c8:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
801055cf:	90                   	nop
  }
...
801055de:	8b 50 28             	mov    0x28(%eax),%edx
...
801055f5:	83 78 10 04          	cmpl   $0x4,0x10(%eax)
...
80105609:	8b 40 28             	mov    0x28(%eax),%eax
...
801056a1:	83 40 0c 01          	addl   $0x1,0xc(%eax)
...
801057c5:	8b 40 0c             	mov    0xc(%eax),%eax
...
80106c3b:	8b 40 0c             	mov    0xc(%eax),%eax
...
80106cb3:	8b 40 0c             	mov    0xc(%eax),%eax
