...
main(void)
{
  ...
  73:	6a 00                	push   $0x0
  75:	e8 d0 02 00 00       	call   34a <wait>
  ...
  b3:	68 ee 07 00 00       	push   $0x7ee
  b8:	e8 bd 02 00 00       	call   37a <exec>
      printf(1, "init: exec sh failed\n");
  bd:	5a                   	pop    %edx
  be:	59                   	pop    %ecx
  bf:	68 f1 07 00 00       	push   $0x7f1
  c4:	6a 01                	push   $0x1
  c6:	e8 d5 03 00 00       	call   4a0 <printf>
      exit();
  cb:	e8 72 02 00 00       	call   342 <exit>
main(void)
{
  int pid, wpid;
  ...
  d1:	6a 01                	push   $0x1
  d3:	6a 01                	push   $0x1
  d5:	68 c0 07 00 00       	push   $0x7c0
  da:	e8 ab 02 00 00       	call   38a <mknod>
    open("console", O_RDWR);
  df:	58                   	pop    %eax
  e0:	5a                   	pop    %edx
  e1:	6a 02                	push   $0x2
  e3:	68 c0 07 00 00       	push   $0x7c0
  e8:	e8 95 02 00 00       	call   382 <open>
